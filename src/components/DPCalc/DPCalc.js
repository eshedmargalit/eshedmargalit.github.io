      ...
      <Container>
        <Row>
          <Col>
            ...
            <h5> The Basics </h5>
            <p>
              d&#39;, also called the sensitivity index, is the primary
              statistic used in Signal Detection Theory. At its core, d&#39; is
              a measure of how far apart two distributions are. If two
              distributions are perfectly overlapping, d&#39;=0 . If two
              distributions are 1 standard deviation apart, d&#39;=1.
            </p>
            <p>
              The equation is:
              <BlockMath
              ...
              />
              where {mu_signal_present} is the mean of the distribution when
              there is a true signal present, {mu_signal_absent} is the mean of
              the distribution when there is no signal present, and {sigma} is
              the standard deviation of the distributions. Note that this
              formula assumes that the standard deviation (
              <InlineMath>\sigma</InlineMath>) is equal for both distributions.
              See below for discussion of the case where this assumption is not
              met.
            </p>
            <h5>Hits, Misses, False Positives, and Correct Rejections</h5>
            <p>
              Given the SignalPresent and SignalAbsent distributions, setting a
              "criterion" tells you the hit rate, miss rate, false positive
              rate, and correct rejection rate. In plain English, the hit rate
              is the proportion of the time that a signal is reported when there
              actually is a signal, and the false positive rate is the
              proportion of the time that a signal is reported when there is no
              signal present.
            </p>
            <p>
              Remember, the miss rate is just one minus the hit rate, and the
              correct rejection rate is just one minus the false positive rate,
            ...
            <p>
              ...
              SignalPresent distribution below the criterion. The false positive
              ...
              high, such that both hits and false positives will be low. A
              "liberal" criterion is relatively low, such that both hits and
              false positives will be high.
            </p>
            <h5> ROC Curves </h5>
            <p>
              ...
              false positive rate and the y-axis is the hit rate. An ROC curve
              is composed of all of the false positive rates and hit rates
              ...
              and thus, the Signal Present and Signal Absent distributions must
